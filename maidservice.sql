...
--
-- Host: localhost
-- Generation Time: Apr 18, 2024 at 05:32 PM
...
CREATE TABLE `Job` (
  ...
  `AddressId` int(11) NOT NULL,
  `Time_Of_Job` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
  `Status` tinyint(4) NOT NULL,
...
ALTER TABLE `Address`
  ...
  ADD KEY `Address_To_Account_FK` (`AccountId`);
...
--
ALTER TABLE `Address`
  ADD CONSTRAINT `Address_To_Account_FK` FOREIGN KEY (`AccountId`) REFERENCES `Account` (`AccountId`);
