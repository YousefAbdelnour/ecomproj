    ...
    <form id="profile_edit_form" method="POST" action="">
        <div class="form-container">
            ...
            <div class="form-group">
                ...
                <input type="text" placeholder="123-456-7890" id="editPhoneNumber" minlength="12" maxlength="12" required name="editPhoneNumber" value="<?php echo isset($data['account_profile']) ? htmlspecialchars($data['account_profile']->Phone_Number) : ''; ?>">
            </div>
            <div class="form-group">
